...
export function WipMessage({Link}: Props) {
  ...
  return (
    <div className="bg-consortium-green-100 text-consortium-blue-800 w-full inline-flex flex-row justify-center items-center text-sm px-4 py-2 gap-1 sm:gap-3">
