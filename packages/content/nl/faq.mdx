...
De Datahub, bestaande uit de Research Applicatie en de Dataset Browser, is momenteel in ontwikkeling. De applicaties kunnen echter al worden bezocht en gebruikt. Het is wel waarschijnlijk dat je in de huidige staat van de Datahub tegen bugs en fouten aanloopt, dus houd hier alsjeblieft rekening mee terwijl je door het platform navigeert. In de loop van 2025 zal het Consortium een reeks video tutorials en webinars publiceren die dieper ingaan op de datahub en hoe deze gebruikt kan worden. In het derde kwartaal zal het Consortium een moment organiseren om de datahub te lanceren. Voor meer informatie over de context van het project en het bredere restitutiebeleid kun je terecht op de website van het Consortium Koloniale Collecties: [www.colonialcollections.org](https://www.colonialcollections.nl/).
